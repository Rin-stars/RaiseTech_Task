        ...
        <div class="f-body-wrap">
            ...
            <header class="l-header c-text--Roboto c-color--lightbrown c-bg-color--lightbeige c-flex--pc-jc-space-between">
                ...
                <form class="p-search" action="サイト内のキーワード検索">        
                    <input class="p-search__input c-color--lightbrown  c-text--M1m-bold-16" name="s" type="text" value="チーズバーガー" />
            ...
            <section class="l-archive">
                ...
                <article class="c-flex--fd-column">
                    <div class="c-flex--fd-column-to-row c-container--card">
                        <div class="c-image--card c-bgp--left-cover-no-repeat"></div>
                        <div class="c-container--card-title c-bg-color--darkbrown">
                            <h4 class="c-text--20-to-pc28 c-text--M1m c-text--lh29 c-text--bold u-pd-bottom--25 c-color--white">見出しが入ります</h4>
